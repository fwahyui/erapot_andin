...
<header class="head">
	<div class="main-bar">
		<h3><i class="icon-home"></i> Tambah Data Guru Matapelajaran</h3>
	</div>
</header>
<?php 
if ($act==0)
	...
	<div class="span12">
		<div class="box">
			<header>
				...
				<h5>Tambah Data Guru Matapelajaran</h5>
			</header>
			<form class="form-horizontal" action="simpanguruajar.php?act=0&tahun=<?php echo $TahunAktif;?>" method="post">
				<br>
